...
class InsertPositionWindow(QWidget):
    ...
    def __init__(self, document_window: 'DocumentWindow'):
        ...
        self.spinbox_pos = sb = QDoubleSpinBox(self)
        ...
        form = QFormLayout()
        form.addRow('Insert Position at:', self.spinbox_pos)
        ...
        self.spinbox_pos.selectAll()

    def form_value_pos(self):
        return round(self.spinbox_pos.value(), self.dw.app.current_length_units().display_decimals)
    ...
    def on_submit(self):
        self.dw.try_insert_positions_command([self.form_value_pos()])
