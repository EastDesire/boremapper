...
class OffsetValuesWindow(QWidget):
    ...
    def __init__(self, document_window: 'DocumentWindow'):
        ...
        self.setWindowTitle('Offset Values')
        ...
        form = QFormLayout()
        form.addRow('Offset Values by:', self.spinbox_offset)
    ...
    def on_submit(self):
        ...
        self.dw.offset_selected_values(offset)
        self.close()
