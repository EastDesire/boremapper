...
Delete "$INSTDIR\beep2.wav"
Delete "$INSTDIR\beep3.wav"
Delete "$INSTDIR\beep1.wav"
Delete "$INSTDIR\beep4.wav"
...
Delete "$DOCUMENTS\${APP_NAME}\sample_flute.xml"
 
 
RmDir "$DOCUMENTS\${APP_NAME}"
!endif
